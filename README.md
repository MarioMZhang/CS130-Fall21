...
This is the repository for the CS130 project Grand Valet. The folder <code>frontend</code> contains the implementation of the frontend web application using React. The folder <code>backend</code> contains the implementation of the web server using Express. The <code>test</code> folder contains the unit tests for the backend, implemented with Python.
