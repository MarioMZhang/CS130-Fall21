        ...
        handler.asyncGetJobsFromID(data.id)
            ...
            .then(final_job=> {
                ...
                if (data.status === 2 || data.status === 7) {
                    ...
                    window.location.href = "/driver?stage=driving&id=" + data.id + "&code=" + data.code + "&hubId=" + data.hubId + "&dpt=" + dpt + "&status=" + job_info.status + "&loc=" + job_info.note + "&type=" + data.type;
                }
                else if (data.status === 4 || data.status ===9) {
                    window.location.href = "/driver?stage=complete&id=" + data.id + "&code=" + data.code + "&hubId=" + data.hubId + "&dpt=" + dpt + "&status=" + job_info.status + "&loc=" + job_info.note + "&type=" + data.type;
                }
                else { // break
                ...
                <ThemeProvider theme={theme}>
                    <Grid container component="main" sx={{ height: '105vh' }}>
                        ...
                        <Grid item xs={12} sm={8} md={5} component={Paper} elevation={6} square>
                            ...
                            >
                                <Box data-testid="test-break-button" component="form" noValidate sx={{ mt: 1 }}>
                                    <br/>
