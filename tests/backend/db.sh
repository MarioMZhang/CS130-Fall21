...
db.Jobs.insertMany([{"type": 1, "jobId": 1, "scheduledTime": 1637096480, "status": 1, "licenceState": "CO", "licenceNum": "CABD12", "hubId": 1, "code": 132561, "carLocation": null, "note": null, "driverUsername": null, "customerUsername": "customer1", "advanceState": [0, 0]},
					{"type": 1, "jobId": 2, "scheduledTime": 1637099480, "status": 1, "licenceState": "CO", "licenceNum": "CABD12", "hubId": 2, "code": 132561, "carLocation": null, "note": null, "driverUsername": null, "customerUsername": "customer2", "advanceState": [0, 0]},])

db.Meta.insertMany([{"maxJobId": 2, "maxHubId": 3}])